---
name: review-drama-script
description: 对已选短剧剧本执行结构、节奏、对白、连续性、合规和可制作性复核。用于 Humanizer 之后、导演本之前，生成可验证的批准门禁。
---

# 复核短剧剧本

读取已选剧本、source-analysis、brief、bible、outline，并读取 [合规清单](../../references/writing/compliance-checklist.md)。由 Codex 使用 `assets/prompts/review_drama_script.{zh,en}.txt` 复核，不调用外部文本模型。
