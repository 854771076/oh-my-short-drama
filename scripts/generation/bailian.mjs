...
export const bailian = {
  ...
  capabilities: { text: false, image: false, video: false, audio: true, music: false, transcription: false, translation: false, voice_design: true, 'video.native-audio': false, 'transform.lip-sync': false, 'transform.video-inpaint': false, 'transform.video-upscale': false },
