...
export const starrouter = {
  ...
  capabilities: { text: false, image: true, video: true, audio: true, music: true, transcription: true, translation: true, 'transform.lip-sync': false, 'transform.video-inpaint': false, 'transform.video-upscale': false },
  async models() {
